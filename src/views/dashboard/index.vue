<template>
  <div class="app-container visualization" :style="{
      background:
        'url(' + require('@/assets/bg5.png') + ') no-repeat center center',
      ...
      <el-row :gutter="20">
        ...
        <el-col class="row-content" :xs="24" :sm="7" :lg="7">
          ...
          <div class="block" :style="{
              borderImageSource: 'url(' + require('@/assets/border1.png') + ')',
            }">
        ...
        <el-col class="row-content" :xs="24" :sm="7" :lg="7">
          ...
          <div class="row-content-r">
            <div class="block" :style="{
                borderImageSource:
                  'url(' + require('@/assets/border1.png') + ')',
              }">
              <el-card class="box-card box-card-r">
                <div id="row-right-1"></div>
              </el-card>
            </div>
            <div class="block box-card-r2" :style="{
                borderImageSource:
                  'url(' + require('@/assets/border1.png') + ')',
              }">
              <el-card class="box-card box-card-r" :style="{
                  borderImageSource:
                    'url(' + require('@/assets/border1.png') + ')',
                }">
...
export default {
  ...
  created() {
    ...
    this.searchForm.startTime =
      parseTime(new Date(), '{y}-{m}') + '-01 00:00:00'
